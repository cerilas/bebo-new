...
const GENERATION_MODE_REQUIRED_MESSAGE = 'Görsel oluşturma modunda değilsiniz. Üstteki Tasarım Hakkı Butonunu Aktif Ederek Tasarım Görselinizi Oluşturabilirsiniz.';
/**
